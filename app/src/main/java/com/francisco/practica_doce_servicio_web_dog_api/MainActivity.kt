...
import com.francisco.practica_doce_servicio_web_dog_api.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    private fun msgError() {
        Toast.makeText(this, "Error en Conexion o la raza no existe", Toast.LENGTH_SHORT).show()
    }
